...
**Completed 2026-07-18.** All phases and automated gates landed, and the Phase
95 hands-on playtest approved arc closure. Its startup-lighting and mutation
stall findings are retained as backlog #8 and #9 for the next arc.
...
Wave 6: [95]         (game integration; hex replaces square; playtest passed, done)
```
...
| 87 — observed_hex Foundation | [phase_87_observed_hex_foundation.md](phase_87_observed_hex_foundation.md) | 1 | complete |
| 88 — 2D Hex WFC Solver + Animated Step Lab | [phase_88_hex_wfc_2d_lab.md](phase_88_hex_wfc_2d_lab.md) | 2 | complete; ∥ 89 |
| 89 — TrenchBroom Tile Pipeline + Tile Lab | [phase_89_tile_pipeline_lab.md](phase_89_tile_pipeline_lab.md) | 2 | complete; ∥ 88; fired the A9 adopt-when trigger |
...
| 94 — Match-Layer Parity | [phase_94_match_parity.md](phase_94_match_parity.md) | 5 | complete; serial |
| 95 — Game Integration & Square Demotion | [phase_95_game_integration.md](phase_95_game_integration.md) | 6 | complete; user playtest passed |
