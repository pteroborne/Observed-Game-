...
pub fn spawn(ctx: &mut SceneCtx) {
    ...
    let strut_specs: [(Vec3, Vec3, f32); 6] = [
        ...
        (Vec3::new(-4.0, 10.0, -58.0), Vec3::new(1.2, 50.0, 1.2), 0.35),
        (Vec3::new(18.0, 2.0, -60.0), Vec3::new(2.2, 40.0, 2.2), -0.25),
        (Vec3::new(-20.0, 0.0, -70.0), Vec3::new(2.6, 52.0, 2.6), 0.15),
        (Vec3::new(4.0, 14.0, -72.0), Vec3::new(1.0, 46.0, 1.0), -0.45),
    ];
