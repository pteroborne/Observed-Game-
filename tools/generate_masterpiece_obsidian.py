#!/usr/bin/env python3
"""
Masterpiece Tile Generator: "The Sanctuary of the Obsidian Lightwell"
Generates a 100% compliant, v2-strict TrenchBroom .map file with integer plane snapping:
- Sunken Hex Base Floor Slab (Z: 0 to 8)
- Central Obsidian Lightwell Pillar (Z: 8 to 128)
- Lower Sloped Inner-Wall Ramp (Z: 8 to 68)
- Cantilevered Gantry Overpass Bridge (Z: 68 to 76)
...
def generate_masterpiece_map():
    map_content = """// Observed 2 Masterpiece Authored Tile: "The Sanctuary of the Obsidian Lightwell"
// Archetype: ramp | Kind: Cell | Register: monument | Rotation: SixFold
// Monumental cathedral cell featuring central obsidian lightwell, cantilevered gantry overpass, & dual spiral ramp helix.

{
"classname" "worldspawn"
{
// 1. Sunken Hex Base Floor Slab (Z: 0 to 8)
...
{
// 2. Central Obsidian Lightwell Pillar Core (Z: 8 to 128)
( 36 36 8 ) ( 36 -36 8 ) ( 36 36 128 ) __TB_empty 0 0 0 1 1
( 36 -36 8 ) ( -36 -36 8 ) ( 36 -36 128 ) __TB_empty 0 0 0 1 1
( -36 -36 8 ) ( -36 36 8 ) ( -36 -36 128 ) __TB_empty 0 0 0 1 1
( -36 36 8 ) ( 36 36 8 ) ( -36 40 128 ) __TB_empty 0 0 0 1 1
...
{
// 4. Cantilevered Gantry Overpass Bridge (Z: 68 to 76)
( 104 36 68 ) ( 104 -36 68 ) ( 104 36 76 ) __TB_empty 0 0 0 1 1
( -104 36 68 ) ( 104 36 68 ) ( -104 36 76 ) __TB_empty 0 0 0 1 1
( -104 -36 68 ) ( -104 36 68 ) ( -104 -36 76 ) __TB_empty 0 0 0 1 1
( 104 -36 68 ) ( -104 -36 68 ) ( 104 -36 76 ) __TB_empty 0 0 0 1 1
...
"classname" "tile_meta"
"authoring_version" "2"
"id" "authored/masterpiece_obsidian_lightwell"
"kind" "cell"
"archetype" "ramp"
"register" "monument"
"register_scope" "all"
...
def main():
    ...
    file_path = out_dir / "masterpiece_obsidian_lightwell.map"
