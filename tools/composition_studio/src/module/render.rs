...
use bevy::prelude::*;
use observed_hex::{CORNERS, TILE_LEVEL_HEIGHT};
...
use crate::module::highlight::spawn_highlight;
...
#[must_use]
pub(super) fn plan(point: (i32, i32), y: f32) -> Vec3 {
...
pub fn rebuild_module_view(
    ...
    mut view: ResMut<crate::module::neighbor_view::NeighbourView>,
    ...
    // The ring last, so the solid centre is already placed and the wireframe
    // reads as something around it. It is a no-op unless the mode is open.
    let ring = super::neighbor_render::emit_ring(
        &mut commands,
        &view,
        &state.diagnoses,
        &mut meshes,
