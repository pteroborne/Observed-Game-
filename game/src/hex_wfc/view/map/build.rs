...
use super::{
    HexMapCell, HexMapLandmark, HexMapOrientationFrame, HexMapPlayerBeacon, HexMapVisual,
    ISO_PITCH, MAP_RENDER_LAYER,
};
...
fn room_marker_role(role: RoomRole) -> MarkerRole {
    match role {
        ...
        | RoomRole::TeleportRelay => MarkerRole::Control,
        _ => MarkerRole::NextRoom,
    }
}
...
fn rooms_present(
    ...
    for blueprint in &world.blueprints {
        ...
        commands.spawn((
            ...
            Name::new(format!("Hex map landmark {} pillar", blueprint.role.label())),
        ));
...
fn spawn_player_marker(
    ...
    commands.spawn((
        ...
        MeshMaterial3d(material),
        RenderLayers::layer(MAP_RENDER_LAYER),
        Transform::from_translation(tip_pos + right_dir * (barb_len * 0.5)).with_rotation(right_rot),
